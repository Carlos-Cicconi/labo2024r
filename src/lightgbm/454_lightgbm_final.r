...
PARAM$finalmodel$num_iterations <- 1347
PARAM$finalmodel$learning_rate <- 0.0100368396102873
PARAM$finalmodel$feature_fraction <- 0.951361149977201
PARAM$finalmodel$min_data_in_leaf <- 767
PARAM$finalmodel$num_leaves <- 448
