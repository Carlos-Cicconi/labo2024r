...
PARAM$finalmodel$num_iterations <- 598
PARAM$finalmodel$learning_rate <- 0.010028694673908
PARAM$finalmodel$feature_fraction <- 0.919537841148805
PARAM$finalmodel$min_data_in_leaf <- 125
PARAM$finalmodel$num_leaves <- 1401


PARAM$finalmodel$max_bin <- 31 # el rango de la BO libre fue [31, 100]
