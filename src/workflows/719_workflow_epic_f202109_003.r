...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(202107, 202106, 202105, 202102,
    202101, 202010, 202009, 202005, 202004) #==> Según recomendación Experimentos Colaborativos


  param_local$train$training <- c(202105, 202104, 202103,
    202012, 202011, 202008, 202007, 202003, 202002)
  param_local$train$validation <- c(202106)
  param_local$train$testing <- c(202107) #==> Según recomendación Experimentos Colaborativos
