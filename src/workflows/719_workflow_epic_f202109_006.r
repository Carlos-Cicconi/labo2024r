...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$final_train$undersampling <- 0.2 #==> Según recomendación Gosende
  param_local$final_train$clase_minoritaria <- c( "BAJA+1", "BAJA+2")
  param_local$final_train$training <- c(202104, 202103, 202012, 202011, 201912,
    201911, 201908, 201907, 201904, 201903) #==> Según recomendación Experimentos Colaborativos


  param_local$train$training <- c(202102, 202101, 202002, 202001,
    201910, 201909, 201906, 201905, 201902, 201901)
  param_local$train$validation <- c(202104)
  param_local$train$testing <- c(202105) #==> Según recomendación Experimentos Colaborativos
...
HT_tuning_epic <- function( pinputexps, bypass=FALSE)
{
  ...
  param_local$train$semillerio <- 20  # ==> uso 20 semillas en la BO
